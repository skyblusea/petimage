    ...
    <FooterContainer ismobile={isMobile}>
      <Box display="flex" flexDirection="column" color="text.secondary" gap="var(--gap-xs)" >
        <Box sx={{ '& > span': { margin: '0px 4px', '::after': { content: '"|"' } } }}>
          ...
          <b>통신판매업신고번호</b>{' '}2018-서울송파-1641<br />
          <b>주소</b>{' '}서울특별시 마포구 동교로22길 50, 202호<br />
        </Box>
        <Box display="flex" gap="var(--gap-md)">
          <a target="_blank" rel="noopenr noreferrer" href="https://voltaic-bit-3dd.notion.site/c40407dba46e423f926ca2d3b9aba495?pvs=4">개인정보처리방침</a>
          <a target="_blank" rel="noopenr noreferrer" href="https://voltaic-bit-3dd.notion.site/e48e39688343443c80d42ee37b390cf3?pvs=4">이용약관</a>
          <a target="_blank" rel="noopenr noreferrer" href="https://forms.gle/vc7rybb7vzGyZqyJ6">문의하기</a>
        </Box>
      </Box>
